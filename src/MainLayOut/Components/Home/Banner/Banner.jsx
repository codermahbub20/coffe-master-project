        ...
        <div className="hero bg-cover bg-center min-h-[90vh] md:min-h-[90vh]" style={{ backgroundImage: 'url(https://i.ibb.co/93HhWyz/3.png)' }}>
            ...
            <div className=" text-center text-white">
                <div className="lg:ml-[500px] mt-12">
                    ...
                    <p className="mb-5 max-w-2xl">It's coffee time - Sip & Savor - Relaxation in every sip! Get the nostalgia back!! Your companion of every moment!!! Enjoy the beautiful moments and make them memorable.</p>
